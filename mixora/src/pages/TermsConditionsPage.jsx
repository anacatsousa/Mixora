			...
			<section>
				...
				<div className="static-page">
					<Container>
						...
						<h2 className="static-page__subtitle">Nature of the Project</h2>
						<p>
						...
						<h2 className="static-page__subtitle">Use of the Service</h2>
						...
						<h2 className="static-page__subtitle">Content</h2>
						<p>
						...
						<h2 className="static-page__subtitle">Disclaimer of Liability</h2>
						<p>
