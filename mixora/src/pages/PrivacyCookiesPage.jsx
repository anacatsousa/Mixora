			...
			<section>
				...
				<div className="static-page">
					<Container>
						...
						<h3 className="static-page__subtitle">No Personal Data Collected</h3>
						<p>
						...
						<h3 className="static-page__subtitle">Cookies</h3>
						...
						<h3 className="static-page__subtitle">Changes to This Policy</h3>
						<p>
